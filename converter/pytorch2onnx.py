...
def parse_args():
    ...
    parser.add_argument('--y_size', default= 32, type=int, help='net input size y')
    parser.add_argument('--x_size', default= 32, type=int, help='net input size x')
...
def convert2onnx(args):
    ...
    model = MobileNetV2_S(num_classes = 2)
    
    weights_path = '../{}/best_model.pt'.format(args.model_dir)
    ...
    model_path =  "{}/zebracrossing_{}.onnx".format(save_dir, input_size)
